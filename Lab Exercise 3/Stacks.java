                        ...
                        for (int i = 0; i < totalStacks; i++) {
                            if (stackNames[i].equals(stackQuery)) {
                                ...
                                switch (Empty(stacks[i])) {
                                    case 1:
                                        System.out.println("Stack " + stackQuery + " is EMPTY.");
                                        break;
                                    case 2:
                                        System.out.println("Stack " + stackQuery + " is FULL.");
                                        break;
                                    default: 
                                        System.out.println("Stack " + stackQuery + " is NEITHER EMPTY NOR FULL.");
                                        break;
                                }
                                break;
                            }
